...
function Home({ ThemeContext }) {
  ...
  const Pricings = [
    {
      name: "Newbie",
      options: ["Limited badges", "Simple profile", "Limited schedule"],
    ...
    {
      name: "Ultra",
      options: ["Full badges", "Full customisable profile", "Pro schedule"],
    ...
    {
      name: "Pro",
      options: ["Pro badges", "Customisable profile", "Pro schedule"],
  ...
  return (
    <div className="flex flex-col">
      <div
        id="homePage"
        className={`relative w-full h-screen pt-28 pb-36 text-white`}
      >
        <div
          className={`absolute top-0 w-full h-screen bg-[#23272F] dark:bg-[#23272F]`}
        >
          <img
            src={homeImage}
            alt=""
        ...
        <div className="pt-20 flex flex-col gap-8 relative">
          <div className="z-10 flex flex-col gap-8">
            <h2 className="text-7xl font-bold px-[400px]">
              Choose your next movie and schedule to watch it
            </h2>
            <p className="text-xl px-[500px]">
              Communicate with cinephile people, see IMDB score of movies,
              genre, ... , and choose your next movie
            </p>
            <div className="flex gap-4 justify-center items-center">
              <Secondbtn
                title={"View plans"}
                customFunction={() => handleClickScroll("home-pricing")}
                size={"medium"}
                clickAnimation={true}
              />
              <Mainbtn
      ...
      <section
        id="home-whatIsBebin"
        className="flex flex-col w-full relative gap-14 justify-center bg-[#F7F8F9] dark:bg-[#191B21] py-32"
      >
        <p
          className={`text-5xl font-semibold ${
            whatIsVisible === true
              ? "animate-[wiggle_2s] opacity-100"
              : "opacity-0"
          }`}
        >
          What is Be<span className="text-amber-500">Bin</span> ?
        </p>
        <div className="overflow-hidden relative">
          <div
            className={`relative h-[600px] left-[50%] overflow-hidden ${
              whatIsVisible === true
                ? "animate-[wiggleLeft_5s] opacity-100"
                : "opacity-0"
            }`}
          >
          ...
          <div
            ref={whatIsRef}
            className={`w-1/2 tracking-wide text-center absolute top-28 left-8 flex flex-col gap-6 ${
              whatIsVisible === true
                ? "animate-[wiggleRight_3s] opacity-100"
                : "opacity-0"
            }`}
          >
            <p className={`text-3xl font-semibold px-8`}>
              BeBin is a platform that you can explore movies , follow critics &
              people, see their wat's about movies and plan your next movie to
              see
              <br />
            </p>
            <span className="font-light text-lg px-24">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Praesentium qui dolor tempora, quis recusandae sed quasi porro
              provident assumenda voluptate?
            </span>
            <div className="mt-4">
              <Secondbtn
                title={"Read more"}
      ...
      <section
        id="home-features"
        className="flex flex-col gap-14 justify-center bg-[#F7F8F9] dark:bg-[#23272F] py-36"
      >
        <p
          className={`text-5xl font-semibold ${
            sec11IsVisible === true
        ...
        <div className="flex items-center justify-start gap-24 px-24">
          <img
            ref={sec11Ref}
            src={theme === "dark" ? sec2svg1dark : sec2svg1}
            className={`w-[450px]  ${
              sec11IsVisible === true
                ? "animate-[wiggleLeft_2s] opacity-100"
                : "opacity-0"
            }`}
            alt=""
          />
          <div
            className={`tracking-wide text-start pr-4pl-40 flex flex-col gap-3 ${
              sec11IsVisible === true
                ? "animate-[wiggle_2s] opacity-100"
                : "opacity-0"
            }`}
          >
            <p className={`text-2xl  list-item  `}>
              ...
              Consult with them and choose your next movie <br />
            </p>
        ...
        <div className="flex items-center justify-start gap-24 px-24 ">
          <div
            ref={sec12Ref}
            className={`tracking-wide text-start pl-40 flex flex-col gap-3 ${
              sec12IsVisible === true
                ? "animate-[wiggle_2s] opacity-100"
                : "opacity-0"
            }`}
          >
            <p className={`text-2xl  list-item  `}>
              Create and schedule your watchlist and set notification
              <br />
              View the time of showing movies in the cinema
              <br />
            </p>
            <span className="font-light text-xl">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <img
            ref={sec12Ref}
            src={theme === "dark" ? sec2svg2dark : sec2svg2}
            className={`w-[450px]  ${
              sec12IsVisible === true
                ? "animate-[wiggleRight_2s] opacity-100"
                : "opacity-0"
            }`}
            alt=""
          />
      ...
      <section
        id="home-critics"
        className="relative flex flex-col gap-10 bg-[#F7F8F9] dark:bg-[#23272F] py-36"
      >
        <p className="text-5xl font-semibold">Our top critics</p>
        <div className="px-32 z-20">{criticsComp}</div>
      </section>
    </div>
  );
}
