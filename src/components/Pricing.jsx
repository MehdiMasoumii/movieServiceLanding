    ...
    <div className="flex flex-col items-center pt-44 pb-28 gap-16 px-40 bg-[#F7F8F9] dark:bg-[#191B21] ">
      ...
      <div className="relative">
        <OptionSlider
          ...
          setOption={setPlanoption}
        />
        <p
          className={`absolute -right-2 -top-5 text-xs font-bold bg-amber-100 text-amber-500 px-1 py-1 rounded-sm ${
            planOption == 0 ? "opacity-60" : "opacity-100"
          }`}
        >
          20% OFF
        </p>
