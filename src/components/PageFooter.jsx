...
function PageFooter({ isVisible, moreVisible }) {
  ...
  return (
    <div className="h-[840px] flex flex-col">
      {moreVisible && (
        <div className="flex flex-col gap-6 pt-32 pb-10 px-36">
          ...
          <div className="grid grid-cols-3 gap-10 ">
            <div className="flex flex-col justify-between gap-8 px-12 py-12 bg-[#F7F8F9] bg-opacity-70 dark:bg-neutral-950 dark:bg-opacity-20 rounded-lg ">
              ...
              <p className="h-[70px]">
                We are happy that we are working with the best Persian language
                critics and have their opinion in this site
              </p>
              <div>
                <Mainbtn
                  title={"Read more"}
            ...
            <div className="flex flex-col justify-between gap-8 px-12 py-12 bg-[#F7F8F9] bg-opacity-70 dark:bg-neutral-950 dark:bg-opacity-20 rounded-lg ">
              ...
              <p className="h-[70px]">
                ...
                Cupiditate cum ad ea soluta voluptate. Quam.
              </p>
              <div>
                <Mainbtn
                  title={"Read more"}
      ...
      <div className="bg-zinc-950 dark:bg-opacity-80 h-full flex justify-between items-center text-white px-12">
        <div className="flex flex-col gap-3 justify-center">
          <Link to="/" className="text-3xl font-bold text-white">
            Be<span className="text-amber-500">Bin</span> Project
          </Link>
        ...
        <div>
          <ul className="flex gap-8">
            <li className="">
              <button
                onClick={() => handleClickScroll("home-whatIsBebin")}
                className="opacity-70 hover:underline hover:opacity-100 underline-offset-8"
              >
                What's Bebin
              </button>
            </li>
            <li className="">
              <button
                onClick={() => handleClickScroll("home-features")}
                className="opacity-70 hover:underline hover:opacity-100 underline-offset-8"
              >
                Features
              </button>
            ...
            <li className="">
              <button
                onClick={() => handleClickScroll("home-pricing")}
                className="opacity-70 hover:underline hover:opacity-100 underline-offset-8"
              >
                Pricing
              </button>
            ...
            <li className="">
              <button
                onClick={() => handleClickScroll("home-critics")}
                className="opacity-70 hover:underline hover:opacity-100 underline-offset-8"
              >
                Critics
              </button>
        ...
        <div className="flex flex-col items-center">
          <p>
            Developed by{" "}
            <Link
              to={"https://github.com/MehdiMasoumii"}
          ...
          <p className="text-sm opacity-50">
            Copyright <CopyrightIcon fontSize="small" /> 2023 All Rights
            Reserved.
          </p>
        </div>
      </div>
